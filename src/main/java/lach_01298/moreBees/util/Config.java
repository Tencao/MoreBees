...
public class Config
{
	...
	public static void readConfig()
	{
		...
		{
			MoreBees.LOGGER.info("Problem loading config file!", e);
		}
		finally
		{
			if(cfg.hasChanged())
	...
	{
		String beeNote = " NOTE: This stops being able to get all bees using this bee by non-creative means i.e. Breeding.";
